...
<div class="flex min-h-screen w-full">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-10 bg-surface-container-lowest">
        <div class="w-full max-w-[420px] flex flex-col gap-4">
            ...
            <button class="w-full flex items-center justify-center gap-sm py-sm px-md bg-surface-container-lowest border border-outline-variant hover:bg-surface-container-low transition-colors duration-200 rounded-xl shadow-sm">
